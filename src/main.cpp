...
int main() {
    ...
    Object objects[obj_len] = {
        { 1, Vec4(0.8, 0.8, 0.8, 0.0), 1, Vec3(5., -5., 2.5), Vec3(2.5, 2.5, 2.5), 0. },
        { 1, Vec4(0.85, 0.85, 0.85, 0.2), 4, Vec3(6., 14., 2.5), Vec3(2.5, 2.5, 2.5), 0. },
        { 2, Vec4(0.4, 0.4, 0.8, 0.0), 3, Vec3(9.5, 5.8, 1.5), Vec3(1.5, 1.5, 1.5), 0. },
        { 2, Vec4(0.95, 0.95, 0.95, 0.3), 3, Vec3(15.5, 7., 2.), Vec3(2., 17., 30.), 0. },
